...
## Setup environment 
# Part one
folder_path = r'PATH\TO\THE\FOLDER\THAT\CONTAINS\THE\IMAGES\FOR\CHECKBOARD\CALIBRATION' # Replace with your image path
image_files = os.listdir(folder_path)
random_image = random.choice(image_files)
image_path = os.path.join(folder_path, random_image)

img = cv2.imread(image_path) # Path for the calibration image process 
...
#images = glob.glob(r'C:\Users\dror\Desktop\project\calibration images\test\*.jpg') 
temp = '\*.jpg'
...
save_path = r'PATH-TO-YOUR-DESIRE-FOLDER\IMAGE.jpg' # Replace with your desired save path
...
def detect_colored_corner(image_path, lower_color, upper_color):
    ...
    return cX, cY
# Example usage
image_path = r'IMAGE\WITH\PURPLE\OBJECT'  # Replace with the path to your image
